...
function total_nights_reflect (offset = '') {
	...
	if(from_date != ''){
		...
		document.getElementById('total_stay').style.display = 'none';
		$('#total_stay').html('');
	}
}
...
function display_addRooms_modal () {
	...
	$.post(base_url + 'view/hotel/display_addRooms_modal.php', { final_arr: final_arr }, function (data) {
...
function generate_rooms () {
	...
	$.post(base_url + 'view/hotel/inc/generate_hotel_rooms.php', { roomCount: roomCount }, function (data) {
...
function generate_child_ages (noOfChilds, roomCount) {
	...
	$.post(
		base_url + 'view/hotel/inc/generate_child_ages.php',
