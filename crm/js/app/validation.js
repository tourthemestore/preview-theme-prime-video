...
function checkDate(id) {
  ...
  if (date == '') {
    ...
    !date.match(/^(0[1-9]|[12][0-9]|3[01])[\- \/.](?:(0[1-9]|1[012])[\- \/.](19|20)[0-9]{2})$/)
  ) {
...
function foo(tableID, quot_table_id, rowCounts) {
  ...
  if (
    ...
    row.cells[4].childNodes[0].setAttribute('id', 'from_sector-' + prefix + foo.counter);
    row.cells[5].childNodes[0].setAttribute('id', 'to_sector-' + prefix + foo.counter);
    row.cells[6].childNodes[0].setAttribute('id', 'txt_plane_company-' + prefix + foo.counter);
    ...
    row.cells[10].childNodes[0].setAttribute('id', 'from_city-' + prefix + foo.counter);
    $(row.cells[10].childNodes[0]).addClass('hidden');
    row.cells[11].childNodes[0].setAttribute('id', 'to_city-' + prefix + foo.counter);
  ...
  if (tableID == 'dynamic_table_list_p_' + quot_table_id) {
    ...
    row.cells[3].childNodes[1].setAttribute(
      'style',
      'position: absolute !important;right: 15px !important; display: flex !important; gap: 15px; background: #f5f5f5 !important;padding: 0px 14px !important; top: 0px !important;'
    );
  ...
  if (
    ...
    row.cells[16].childNodes[0].setAttribute('id', 'meal_plan-' + prefix + foo.counter);
  ...
  if (
    ...
    row.cells[7].childNodes[0].setAttribute('id', 'duration-' + foo.counter);
    row.cells[8].childNodes[0].setAttribute('id', 'no_vehicles-' + foo.counter);
    row.cells[9].childNodes[0].setAttribute('id', 'transport_cost-' + foo.counter);
    row.cells[10].childNodes[0].setAttribute('id', 'package_name-' + foo.counter);
    row.cells[11].childNodes[0].setAttribute('id', 'package_id-' + foo.counter);
    row.cells[12].childNodes[0].setAttribute('id', 'pickup_type-' + foo.counter);
  ...
  if (tableID == 'tbl_dynamic_exc_booking' || tableID == 'tbl_dynamic_exc_booking_update') {
    ...
    if (tableID == 'tbl_dynamic_exc_booking') {
      ...
      var function_name1 =
        "excursion_amount_calculate(id);calculate_exc_expense('" + tableID + "')";
    } else {
    ...
    row.cells[8].childNodes[0].setAttribute('id', 'total_infant-' + prefix + current_counter);
    row.cells[9].childNodes[0].setAttribute('id', 'adult_cost-' + prefix + current_counter);
    row.cells[10].childNodes[0].setAttribute('id', 'child_cost-' + prefix + current_counter);
    row.cells[11].childNodes[0].setAttribute('id', 'infant_cost-' + prefix + current_counter);
    row.cells[12].childNodes[0].setAttribute('id', 'total_vehicle-' + prefix + current_counter);
    row.cells[13].childNodes[0].setAttribute('id', 'transfer_cost-' + prefix + current_counter);
    row.cells[14].childNodes[0].setAttribute('id', 'total_amount-' + prefix + current_counter);
  ...
  if (tableID == 'tbl_package_tour_quotation_dynamic_costing') {
    ...
    row.cells[8].childNodes[3].setAttribute('id', 'discount_in-' + foo.counter);
    row.cells[9].childNodes[1].setAttribute('id', 'discount_amt-' + foo.counter);
    row.cells[10].childNodes[3].setAttribute('id', 'tax_apply_on-' + foo.counter);
    row.cells[11].childNodes[3].setAttribute('id', 'tax_value-' + foo.counter);
    row.cells[12].childNodes[1].setAttribute('id', 'service_tax_subtotal-' + foo.counter);
    row.cells[13].childNodes[3].setAttribute('id', 'tcs_tax-' + foo.counter);

    row.cells[14].childNodes[3].setAttribute('id', 'tcs1-' + foo.counter);
    ...
    row.cells[15].childNodes[3].setAttribute('id', 'tds-' + foo.counter);

    row.cells[16].childNodes[3].setAttribute('id', 'total_tour_cost-' + foo.counter);
  ...
  if (tableID == 'tbl_hotel_booking' || tableID == 'tbl_hotel_booking_update') {
    ...
    row.cells[2].childNodes[0].setAttribute('id', 'tour_type' + prefix + foo.counter);
    row.cells[3].childNodes[0].setAttribute('id', 'city_id' + prefix + foo.counter);
    row.cells[4].childNodes[0].setAttribute('id', 'hotel_id' + prefix + foo.counter);
    ...
    row.cells[6].childNodes[0].value = today;
    dynamic_datetime(row.cells[6].childNodes[0].id);
    row.cells[7].childNodes[0].setAttribute('id', 'no_of_nights' + prefix + foo.counter);
    row.cells[8].childNodes[0].setAttribute('id', 'rooms' + prefix + foo.counter);
    row.cells[9].childNodes[0].setAttribute('id', 'room_type' + prefix + foo.counter);
    row.cells[10].childNodes[0].setAttribute('id', 'category' + prefix + foo.counter);
    row.cells[11].childNodes[0].setAttribute('id', 'accomodation_type' + prefix + foo.counter);
    row.cells[12].childNodes[0].setAttribute('id', 'extra_beds' + prefix + foo.counter);
    row.cells[13].childNodes[0].setAttribute('id', 'meal_plan' + prefix + foo.counter);
    row.cells[14].childNodes[0].setAttribute('id', 'conf_no' + prefix + foo.counter);
  ...
  if (tableID == 'tbl_dynamic_visa' || tableID == 'tbl_dynamic_visa_update') {
    ...
    for (var i = row.cells[13].childNodes[0].attributes.length; i-- > 0; )
      row.cells[13].childNodes[0].removeAttributeNode(row.cells[13].childNodes[0].attributes[i]);
    row.cells[13].childNodes[0].setAttribute('id', 'appointment' + prefix + foo.counter);
    ...
    if (tableID == 'tbl_dynamic_visa') {
      row.cells[14].childNodes[0].setAttribute('id', 'visa_cost' + prefix + foo.counter);
  ...
  if (tableID == 'tbl_dynamic_ticket_master') {
    ...
    row.cells[33]
      ...
      .setAttribute('onclick', "add_flight_details(this.id, 'save')");

    row.cells[12].childNodes[0].setAttribute('class', 'form-control main_ticket');
    row.cells[13].childNodes[0].setAttribute('id', 'flight_details' + foo.counter);
    $(row.cells[13]).addClass('hidden');
  ...
  if (tableID == 'tbl_dynamic_ticket_master_update') {
    ...
    row.cells[12].childNodes[0].setAttribute('class', 'form-control main_ticket');
    row.cells[13].childNodes[0].setAttribute('id', 'flight_details' + idx + prefix);
    row.cells[14].childNodes[0].setAttribute('id', 'add_trips' + idx + prefix);

    row.cells[14]
      .querySelector('button')
      .setAttribute('onclick', "add_flight_details_1(this.id, 'update')");
  ...
  if (tableID == 'tbl_similar_package_hotels' + quot_table_id) {
    row.cells[0].childNodes[0].setAttribute('id', 'ochk_plan' + quot_table_id + foo.counter);
    row.cells[2].childNodes[0].setAttribute('id', 'oavail1' + quot_table_id + foo.counter);
    // row.cells[2].childNodes[0].selectedIndex = 1;
    row.cells[3].childNodes[0].setAttribute('id', 'city_id1' + quot_table_id + foo.counter);
    row.cells[4].childNodes[0].setAttribute('id', 'hotel_id1' + quot_table_id + foo.counter);
    row.cells[5].childNodes[0].setAttribute('id', 'omobile_no1' + quot_table_id + foo.counter);
    row.cells[6].childNodes[0].setAttribute('id', 'oemail_id1' + quot_table_id + foo.counter);
    row.cells[7].childNodes[0].setAttribute('id', 'oreply_by1' + quot_table_id + foo.counter);
    row.cells[8].childNodes[0].setAttribute('id', 'ospec1' + quot_table_id + foo.counter);
  }
  ...
  for (var i = 0; i < colCount; i++) {
    ...
    newcell.childNodes[0].title =
      table.rows[0].cells[i].childNodes[0].title != ''
        ? table.rows[0].cells[i].childNodes[0].title
        : table.rows[0].cells[i].childNodes[0].getAttribute('data-original-title');
