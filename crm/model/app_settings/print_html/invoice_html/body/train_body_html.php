...
<div class="row">
  <div class="col-md-12 mg_tp_20">
    <p class="border_lt"><span class="font_5">PASSENGER (s): <?= $sq_passenger_count['cnt'] ?></span></p>
  </div>
</div>
    ...
    <div class="col-md-12">
      <div class="main_block inv_rece_calculation border_block">
        <?php if ($service_charge_switch == 'No') { ?>
          <div class="col-md-6">
            <p class="border_lt"><span class="font_5">BASIC AMOUNT </span><span class="float_r"><?php echo $currency_code . " " . number_format($basic_service_amt, 2); ?></span></p>
          </div>
        <?php } else { ?>
          <div class="col-md-6">
            <p class="border_lt"><span class="font_5">BASIC AMOUNT </span><span class="float_r"><?php echo $currency_code . " " . number_format($newBasic, 2); ?></span></p>
          </div>
        <?php } ?>
        ...
        <div class="col-md-6">
          <p class="border_lt"><span class="font_5">DELIVERY CHARGE </span><span class="float_r"><?php echo $currency_code . " " . number_format($sq_fields['delivery_charges'], 2); ?></span></p>
        </div>
        <div class="col-md-6">
        ...
        <div class="col-md-6">
          <p class="border_lt"><span class="font_5">TAX</span><span class="float_r"><?= $tax_show ?></span></p>
        </div>
        <?php
        if ($bg != '') { ?>
          <div class="col-md-6">
            <p class="border_lt"><span class="font_5">CANCELLATION CHARGES</span><span class="float_r"><?= $currency_code . ' ' . $canc_amount ?></span></p>
          </div>
          <div class="col-md-6">
            <p class="border_lt"><span class="font_5">ROUNDOFF </span><span class="font_5 float_r"><?= $currency_code . " " . $roundoff ?></span></p>
          </div>
        <?php } ?>
        <div class="col-md-6">
