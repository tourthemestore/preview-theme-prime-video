...
$currency_code1 =$row_misc['currency_code'];
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="main_block inv_rece_calculation border_block">
        ...
        <?php } ?>
        <div class="col-md-6"><p class="border_lt"><span class="font_5">TOTAL </span><span class="font_5 float_r"><?= currency_conversion($currency,$currency_code1 , $net_amount1) ?></span></p></div>
        <div class="col-md-6"><p class="border_lt"><span class="font_5">OTHER CHARGES AND TAXES </span><span class="float_r"><?= currency_conversion($currency,$currency_code1 ,$other_charges) ?></span></p></div>
        ...
        <?php if($service_charge_switch == 'Yes'){ ?>
          <div class="col-md-6"><p class="border_lt"><span class="font_5">SERVICE CHARGE </span><span class="float_r"><?= currency_conversion($currency,$currency_code1 ,$newSC )?></span></p></div>
        <?php }else{ ?>
          <div class="col-md-6"><p class="border_lt"><span class="font_5"> </span><span class="float_r"></span></p></div>
        <?php } ?>
        <div class="col-md-6"><p class="border_lt"><span class="font_5">ADVANCE PAID </span><span class="font_5 float_r"><?= currency_conversion($currency,$currency_code1 ,$total_paid) ?></span></p></div>
        ...
        <div class="col-md-6"><p class="border_lt"><span class="font_5">ROUND OFF </span><span class="float_r"><?= currency_conversion($currency,$currency_code1 ,$roundoff) ?></span></p></div>
        <?php } ?>
