...
class master{
    ...
    public function image_delete(){
        ...
        $sq_delete = mysqlQuery("update bike_master set image_upload_url = '' where entry_id='$image_id'");
        if($sq_delete){
            echo "Image Deleted";
        }
    }
    ...
    function tariff_save(){
        ...
        $ofrom_date_array = isset($_POST['ofrom_date_array']) ? $_POST['ofrom_date_array'] : [];
        $oto_date_array = isset($_POST['oto_date_array']) ? $_POST['oto_date_array']: [];
    ...
    function tariff_update(){
        ...
        $offer_array = isset($_POST['offer_array']) ? $_POST['offer_array'] : [];
        $agent_type_array = isset($_POST['agent_type_array']) ? $_POST['agent_type_array'] : [];
        $offer_entryid_array = isset($_POST['offer_entryid_array']) ? $_POST['offer_entryid_array'] : [];
