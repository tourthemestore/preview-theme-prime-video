...

{
    ...
    $sq_est = mysqlQuery("insert into refund_tour_estimate(estimate_id, tourwise_traveler_id, cancel_amount, total_refund_amount, created_at,`tax_value`,`tax_amount`,`cancel_amount_exc`) values ('$estimate_id', '$tourwise_id', '$cancel_amount', '$total_refund_amount', '$created_at','$tax_value','$tour_service_tax_subtotal','$cancel_amount_exc')");       
