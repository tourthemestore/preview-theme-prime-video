          ...
          <div class="adolence_info">
            ...
            <ul class="main_block">
              ...
              while ($row_tariff = mysqli_fetch_assoc($sq_tariff)) {
                ...
                $total_cost = (float)($row_tariff['cadult']);
                $ccwb = (float)($row_tariff['ccwb']);
                $ccwob = (float)($row_tariff['ccwob']);
                $cinfant = (float)($row_tariff['cinfant']);
                $cextra = (float)($row_tariff['cextra']);
    ...
    <div class="container">
      ...
      <script type="text/javascript">
        ...
        function display_gallery(hotel_name, btn_id) {
          ...
          $.post('../package_tour/quotation/display_hotel_gallery.php', {
