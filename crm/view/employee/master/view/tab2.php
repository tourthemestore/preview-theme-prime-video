<div class="row">
	...
	<div class="col-md-12 mg_tp_10">
		...
		<div class="profile_box main_block">
			...
			<div class="row">
				<div class="col-md-6 right_border_none_sm" style="border-right: 1px solid #ddd; min-height: 105px;">		        
				            ...
				            <span class="main_block">
									...
									<?php echo "<label>Dearness Allowance : </label> ".number_format($sq_emp['dear_allow'],2); ?>
				            ...
				            <span class="main_block">
								...
								<?php echo "<label>Medical Allowance : </label> ".number_format($sq_emp['medi_allow'],2); ?>
				    ...
				    <div class="col-md-6">		        
				        ...
				        <span class="main_block">
								...
								<?php echo "<label>Uniform Allowance : </label> ".number_format($sq_emp['uniform_allowance'],2); ?>
			...
			<div class="profile_box main_block"><hr>
		        <div class="row">
