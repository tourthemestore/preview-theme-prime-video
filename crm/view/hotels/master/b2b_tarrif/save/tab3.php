                            ...
                            <div class="table-responsive">
                                <table id="table_hotel_weekend_tarrif" name="table_hotel_weekend_tarrif" class="table table-bordered no-marg pd_bt_51" style="min-width:1500px">
                                    <tr>
                                        ...
                                        <td><select name="room_cat2" id="room_cat2" style="width:145px;" title="Room Category" class="form-control app_select2"><?php get_room_category_dropdown(); ?></select>
                                        </td>
                                        ...
                                        <td><select name="day" id="day" style="width:155px;" title="Weekend Day" class="form-control app_select2">
                                        ...
                                        <td><input type="text" id="flat_markup" name="flat_markup" placeholder="Markup" title="Markup" onchange="validate_balance(this.id)" style="width: 120px;" />
                                        </td>
