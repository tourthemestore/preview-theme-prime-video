...
<div class="modal fade profile_box_modal" id="hotel_display_modal" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog modal-lg" role="document">
    ...
    $currency_amount_3 = currency_conversion($currency,$row_entry['currency_code'],$total_purchase);
    if($row_entry['currency_code'] !='0' && $currency != $row_entry['currency_code']){
      $currency_amount_3 = ' ('.$currency_amount_3.')';
    }else{
      $currency_amount_3 = '';
    }
  }
                    ...
                    ?>
                      <tr>
                        ...
                        <td><?php echo number_format($total_purchase, 2).$currency_amount_3; ?></td>
