            ...
            <tfoot>
                ...
                <tr class="active">
                    <th colspan="2" class="info">Refund :
                        <?= ($sq_refund['sum'] == "") ? number_format(0, 2) : number_format($sq_refund['sum'], 2) ?>
                    </th>
                    <th colspan="2" class="warning">Pending :
                        <?= ($sq_pending['sum'] == "") ? number_format(0, 2) : number_format($sq_pending['sum'], 2) ?>
                    </th>
                    <th colspan="2" class="danger">Cancelled :
                        <?= ($sq_cancel['sum'] == "") ? number_format(0, 2) : number_format($sq_cancel['sum'], 2) ?>
                    </th>
                    <th colspan="2" class="success">Total_Refund :
                        <?= number_format(($sq_refund['sum'] - $sq_pending['sum'] - $sq_cancel['sum']), 2) ?></th>
                </tr>
            </tfoot>
        </table>
