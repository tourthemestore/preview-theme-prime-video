...
$array_s = array();
	...
	while($row_quotation = mysqli_fetch_assoc($sq_quotation)){
		...
		$currency_amount1 = currency_conversion($currency, $row_quotation['currency_code'], $row_quotation['quotation_cost']);

		if ($row_quotation['currency_code'] != '0' && $currency != $row_quotation['currency_code'] && $row_quotation['quotation_cost'] != $currency_amount1) {
