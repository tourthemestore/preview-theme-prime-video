		...
		<div class="profile_box main_block" style="min-height: 141px;">
			...
			<div class="row">
				<div class="col-sm-6 col-xs-12 right_border_none_sm_xs" style="border-right: 1px solid #ddd">
					...
					<span class="main_block">
						<i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
						<?php echo "<label>Discount  <em>:</em></label> ".$sq_package_info['discount'].$discount_in; ?>
					</span>
					<span class="main_block">
						<i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
						<?php echo "<label>Subtotal  <em>:</em></label> ".number_format($sq_package_info['subtotal'],2); ?>
					</span>
					<span class="main_block">
						<i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
				...
				<div class="col-sm-6 col-xs-12 right_border_none_sm_xs">
					...
					<span class="main_block">
						<i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
						<?php echo '<label>TCS'.'('.$sq_package_info['tcs_tax'].'%)'.'<em>:</em></label> '.$sq_package_info['tcs_per']; ?>
					</span>
					<span class="main_block">
						<i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
						<?php echo "<label>TDS<em>:</em></label> ".$sq_package_info['tds']; ?>
					</span>
					<?php
