...
<button type="button" class="btn btn-excel btn-sm" onclick="addRow('table_transfer_tarrif','1')" title="Add row"><i
        class="fa fa-plus"></i></button>
<button type="button" class="btn btn-pdf btn-sm" onclick="deleteRow('table_transfer_tarrif','1')" title="Delete row"><i
...
<div class="row mg_bt_10">
    <div class="col-md-12">
        <div class="table-responsive">
            <table id="table_transfer_tarrif" name="table_transfer_tarrif"
                class="table table-bordered table-hover table-striped no-marg pd_bt_51" style="width:100%;">
                <tr>
                    <td><input class="css-checkbox" id="chk_transfer1" type="checkbox" checked><label class="css-label"
                            for="chk_transfer1"> </label></td>
                    ...
                    <td><select name="pickup_from" id="pickup_from" data-toggle="tooltip" style="width:150px;"
                            title="Pickup Location" class="form-control app_minselect2">
                    ...
                    <td><select name="drop_to" id="drop_to" style="width:155px;" data-toggle="tooltip"
                            title="Drop-off Location" class="form-control app_minselect2">
                    ...
                    <td><select name="duration" id="duration" style="width:170px;" title="*Service Duration"
