...
if ($sq_type['type_id'] == '1') {
  $type = 'Transactional';
} elseif ($sq_type['type_id'] == '2') {
  $type = 'Reminder';
}
...
<script type="text/javascript">
  function display_fraft() {
    ...
    $('#draft_reader div, #draft_reader b, #draft_reader span, #draft_reader font').css({
  ...
  $(function() {
    $('#frm_cms_save').validate({
      ...
      submitHandler: function(form) {
        ...
        $.ajax({
          type: 'post',
          url: base_url + 'controller/crm/email_cms_master.php',
          data: {
            entry_id: entry_id,
            subject: subject,
            draft: draft,
