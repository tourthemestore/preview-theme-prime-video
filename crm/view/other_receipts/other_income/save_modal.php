        ...
        <div class="modal-body">
          ...
          <div class="panel panel-default panel-body app_panel_style feildset-panel">
            ...
            <div class="row">
              ...
              <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
                <input type="text" name="cust_pan_no" id="cust_pan_no" onchange="validate_specialChar(this.id)" placeholder="Personal Identification No(PIN)" title="Personal Identification No(PIN)" style="text-transform: uppercase;">
              </div>
...
<script>
  ...
  $('#payment_date,#booking_date').datetimepicker({
    timepicker: false,
    format: 'd-m-Y'
  });
