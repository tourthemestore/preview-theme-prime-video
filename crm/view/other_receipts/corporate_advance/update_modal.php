      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="row">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
              <input type="number" id="transaction_id" name="transaction_id" onchange="validate_balance(this.id)" class="form-control" placeholder="Cheque No/ID" title="Cheque No/ID" <?= $disabled ?> value="<?= $sq_income_info['transaction_id'] ?>">
            </div>
            <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
...
<script>
  ...
  $('#frm_update').validate({
    ...
    submitHandler: function(form) {
      ...
      if (!check_updated_amount(payment_amount_old, payment_amount)) {
        error_msg_alert("You can update advance to 0 only!");
      ...
      $.ajax({
        ...
        data: {
          ...
          payment_amount_old: payment_amount_old
        },
