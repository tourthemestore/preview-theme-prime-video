...
$('#cmb_tourwise_traveler_id,#acurrency_code1').select2();
  ...
  $('#frm_payment_update').validate({
    ...
    submitHandler:function(form){
      ...
      var canc_status = $('#canc_status1').val();
       ...
       var currency_code1 =$('#acurrency_code1').val();
