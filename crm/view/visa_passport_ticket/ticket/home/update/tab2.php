			...
			$count++;
				...
				<div class="dynform-item">
					...
					<div class="row">
						...
						<div class="col-md-2 col-sm-4 col-xs-12 mg_bt_10">
							<input type="text" id="luggage-1" onchange=" validate_specialChar(this.id)" name="luggage" placeholder="Cabin Baggage" title="Cabin Baggage" data-dyn-valid="" value="<?php echo $row_entry['luggage']; ?>">
				        </div>
...
get_auto_values('booking_date1','basic_cost','payment_mode','service_charge','markup','update','true','service_charge','discount');
</script>
<style>
#project-label {
    display: block;
