...
<?php
	...
	<div class="row">
		...
		<div class="col-md-2 col-sm-4 col-xs-12 mg_bt_10">
			<input type="text" id="booking_date1" name="booking_date1" placeholder="Booking Date" title="Booking Date" onchange="get_auto_values('booking_date1','basic_fair','payment_mode','service_charge','markup1','update','true','service_charge','discount1');" value="<?= get_date_user($sq_booking['created_at']) ?>" onchange="check_valid_date(this.id)">
		</div>
	</div>
