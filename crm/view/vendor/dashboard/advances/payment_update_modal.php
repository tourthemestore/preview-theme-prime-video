          ...
          <legend>Update Payment</legend>
            ...
            <div class="row">
              <div class="col-md-8">
                  ...
                  <button type="button" data-toggle="tooltip" data-placement="bottom" class="btn btn-excel" title="Only JPG, PNG, PDF files are allowed."><i class="fa fa-question-circle" style="margin-left:10px;"></i></button>
                </div>
            </div>         
...
$(document).ready(function () {
  ...
  // Apply inline styles when the tooltip is shown
  $('[data-toggle="tooltip"]').on('shown.bs.tooltip', function () {
    $('.tooltip-inner').attr('style', 'background-color: black; color: white;');
    $('.tooltip .arrow::before').attr('style', 'background-color: black;');
  });
});
