				...
				<legend>Select Sale</legend>
					<div class="row">
						...
						<div class="col-md-6 col-sm-3 col-xs-12 mg_bt_10">
							...
							<textarea id="purchase_flag" name="purchase_flag" placeholder="List of purchases already done" readonly style="width: 500px; height: 100px;"></textarea>
						</div>
					</div>
...
function estimate_section_add() {
    if (isProcessing) return; // Prevent multiple clicks at the same time
    ...
    $.post('dynamic_estimate_section.php', { dynamic_estimate_count: dynamic_estimate_count }, function(data) {
        ...
        isProcessing = false; // Reset flag if request fails
    });
}
