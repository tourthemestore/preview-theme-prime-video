...
<form id="frm_basic_info">
	...
	<div class="panel panel-default panel-body app_panel_style feildset-panel mg_bt_30">
		...
		<div class="row mg_tp_20">
			...
			<div class="col-md-4">
				<input type="text" id="app_email_id_t" name="app_email_id" placeholder="Email ID" title="Email ID"
	...
	$(function() {
		...
		$('#frm_basic_info').validate({
			...
			submitHandler: function(form) {
				...
				var app_email_id1 = $('#app_email_id_t').val();
