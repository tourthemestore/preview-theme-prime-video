...
<div class="row text-right mg_bt_20">
    <div class="col-md-12">
        ...
        <button class="btn btn-info btn-sm ico_left" data-toggle="modal" data-target="#exc_payment_save_modal"><i
    ...
    <div class="row">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
            <button class="btn btn-sm btn-info ico_right"
                onclick="exc_payment_list_reflect();bank_receipt()">Proceed&nbsp;&nbsp;<i
...
function excel_report() {
    ...
    window.location = 'payment/excel_report.php?customer_id=' + customer_id + '&exc_id=' + exc_id + '&from_date=' +
    ...
    $('#vi_confirm_box').vi_confirm_box({
        callback: function(data1) {
            if (data1 == "yes") {
                var branch_status = $('#branch_status').val();
                var base_url = $('#base_url').val();
                $.post(base_url + 'controller/excursion/exc_master_payment_delete.php', {
                    payment_id: payment_id
                }, function(data) {
