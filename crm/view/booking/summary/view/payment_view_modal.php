                    ...
                    <table  class="table table-bordered no-marg">
                      ...
                      while($row_entry = mysqli_fetch_assoc($sq_query))
                      {
                        ...
                        $bg='warning';
                          ...
                          $pkg_query=mysqli_fetch_assoc(mysqlQuery("select * from tourwise_traveler_details  where traveler_group_id='$id'"));

                            $currency_amount2 = currency_conversion($row_entry['currency_code'],$pkg_query['currency_code'],$row_entry['amount']);

                            if($pkg_query['currency_code'] !='0' && $row_entry['currency_code']!= $pkg_query['currency_code'] && $quotation_cost != $currency_amount2){
                          ...
                          <tr class="<?= $bg ?>">
                              ...
                              <td><?php echo number_format($row_entry['amount'],2).$currency_amount; ?></td>
                          </tr>  
                          <?php
                        }
                        ?>
