    ...
    <div class="container-fluid">
        <div class="app_panel_content no-pad">
            <div class="panel panel-default panel-body app_panel_style feildset-panel mg_tp_20">
                ...
                ?>
                <input type="hidden" value="<?= $traveler_group_id ?>" id="traveler_group_id"
                    name="traveler_group_id" />
                <div class="row">
                    <div class="col-xs-12">
                        <div class="table-responsive">
                            <table id="tbl_member_dynamic_row" class="table table-bordered table-hover table-striped"
                                style="width:1504px">
                                <?php
                                $count_m = 0;
                                $bg;
                                ...
                                while ($row_traveler_grop_details = mysqli_fetch_assoc($sq_traveler_grop_details)) {
                                    $count_m++;
                                    $sq_entry = mysqli_fetch_assoc(mysqlQuery("select * from tourwise_traveler_details where traveler_group_id='$traveler_group_id' and delete_status='0'"));
                                ...
                                <tr class="<?= $bg ?>">
                                    ...
                                    <td><select id="<?= 'cmb_m_honorific' . $count_m . 'm' ?>" data-toggle="tooltip"
                                            onchange="changeGender(this.id)" title="Honorific"
                                            name="<?= 'cmb_m_honorific' . $count_m . 'm' ?>" <?= $disabled; ?>>
                                            <option value="<?php echo $row_traveler_grop_details['m_honorific'] ?>">
                                    ...
                                    <td><input style="width: 129px;" type="text"
                                            id="<?php echo 'txt_m_first_name' . $count_m . 'm' ?>"
                                            name="<?php echo 'txt_m_first_name' . $count_m . 'm' ?>" <?= $disabled; ?>
                                            onchange="fname_validate(this.id); payment_details_reflected_data('tbl_member_dynamic_row');"
                                            title="First Name" placeholder="First Name"
                                            value="<?php echo $row_traveler_grop_details['first_name'] ?>" required />
                                    </td>
                                    <td><input style="width: 129px;" type="text"
                                            id="<?php echo 'txt_m_middle_name' . $count_m . 'm' ?>"
                                            name="<?php echo 'txt_m_middle_name' . $count_m . 'm' ?>" <?= $disabled; ?>
                                            onchange="fname_validate(this.id); payment_details_reflected_data('tbl_member_dynamic_row');"
                                            title="Middle Name" placeholder="Middle Name"
                                            value="<?php echo $row_traveler_grop_details['middle_name'] ?>" /></td>
                                    <td><input style="width: 129px;" type="text"
                                            id="<?php echo 'txt_m_last_name' . $count_m . 'm' ?>"
                                            name="<?php echo 'txt_m_last_name' . $count_m . 'm' ?>" <?= $disabled; ?>
                                            onchange="fname_validate(this.id); payment_details_reflected_data('tbl_member_dynamic_row');"
                                            placeholder="Last Name" title="Last Name"
                                            value="<?php echo $row_traveler_grop_details['last_name'] ?>" /></td>

                                    <td><select id="<?php echo 'cmb_m_gender' . $count_m . 'm' ?>" title="Gender"
                                            name="<?php echo 'cmb_m_gender' . $count_m . 'm' ?>" <?= $disabled; ?>
                                            style="width:60px;">
                                            <?php
                                    ...
                                    <td><input maxlength="20" type="text"
                                            ...
                                            <?= $disabled; ?> title="Birth Date" style="width: 100px;"
                                            onchange="calculate_age_member(this.id); payment_details_reflected_data('tbl_member_dynamic_row');"
                                    ...
                                    <td><input style="width: 100px;" type="text"
                                            ...
                                            value="<?php echo $row_traveler_grop_details['age'] ?>" title="Age(Y:M:D)"
                                            placeholder="Age"
                                    ...
                                    <td><select id="<?php echo 'txt_m_adolescence' . $count_m . 'm' ?>"
                                            ...
                                            <?php
                                                ...
                                                if ($row_traveler_grop_details['adolescence'] == "Child With Bed") {
                                                    $adlc = "CB";
                                                }
                                                if ($row_traveler_grop_details['adolescence'] == "Child Without Bed") {
                                                    $adlc = "CWB";
                                                }
                                                ...
                                                ?>
                                            <option value="<?php echo $row_traveler_grop_details['adolescence'] ?>">
                                    ...
                                    <td><input type="text" id="txt_m_passport_no<?= $count_m ?>m"
                                            name="txt_m_passport_no" placeholder="Passport No" title="Passport No"
                                            onchange="validate_specialChar(this.id);payment_details_reflected_data('tbl_member_dynamic_row')"
                                            <?= $disabled; ?> value="<?= $row_traveler_grop_details['passport_no'] ?>"
                                            style="text-transform: uppercase;width: 139px;"></td>
                                    <td><input type="text" id="txt_m_passport_issue_date<?= $count_m ?>m"
                                            name="txt_m_passport_issue_date" placeholder="Issue Date"
                                            title="Passport Issue Date"
                                            onchange=" payment_details_reflected_data('tbl_member_dynamic_row');checkPassportDate(this.id)"
                                            <?= $disabled; ?>
                                            value="<?php echo get_date_user($row_traveler_grop_details['passport_issue_date']); ?>"
                                            style="width: 130px;"></td>
                                    <td><input type="text" id="txt_m_passport_expiry_date<?= $count_m ?>m"
                                            name="txt_m_passport_expiry_date"
                                            value="<?php echo get_date_user($row_traveler_grop_details['passport_expiry_date']); ?>"
                                            title="Passport Expiry Date" placeholder="Expiry Date"
                                            onchange="payment_details_reflected_data('tbl_member_dynamic_row');checkExpiryDate(this.id)"
                                            style="width: 132px;" <?= $disabled ?>></td>
                                    <td><input type="hidden"
                                            value="<?php echo $row_traveler_grop_details['traveler_id'] ?>"></td>
                                </tr>
                                <?php
                                }
                                ?>
