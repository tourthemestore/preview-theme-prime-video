...
<div class="row mg_bt_20">
    <div class="col-sm-1 col-xs-2 mg_bt_10_xs">
        <select class="form-control pull-left" id="cmb_r_honorific" name="cmb_r_honorific" title="Honorific"
            data-toggle="tooltip">
    ...
    <div class="col-md-3 col-sm-7 col-xs-10 mg_bt_10_xs">
        <input class="form-control" type="text" id="txt_r_name" name="txt_r_name" onchange="fname_validate(this.id)"
    ...
    <div class="col-md-3 col-sm-12 col-xs-12">
        <input class="form-control" type="text" onchange="mobile_validate(this.id)" id="txt_r_mobile"
