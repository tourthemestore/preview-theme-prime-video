    ...
    for(var i=0; i<rowCount; i++)
    {
      ...
      var current_row = parseInt(i)+1;
       ...
       if(row.cells[0].childNodes[0].checked)
       {
        ...
        if(date == "")
        {
          error_msg_alert("Select date for flight details at row "+current_row);
          row.cells[2].childNodes[0].focus();
          return false;
        }
        if(arravl1 == "")
        {
          error_msg_alert("Arrival date and time flight details at row "+current_row);
          row.cells[3].childNodes[0].focus();
          return false;
        }  
        ...
        if(company1 == "")
        {
          error_msg_alert("Enter airline name for flight details at row "+current_row);
          row.cells[6].childNodes[0].focus();
          return false;
        }
        if(class1 == "")
        {
          error_msg_alert("Select class for flight details at row "+current_row);
          row.cells[7].childNodes[0].focus();
          return false;
        }
        if(amount1 == "")
        {
          error_msg_alert("Enter amount for flight details at row "+current_row);
