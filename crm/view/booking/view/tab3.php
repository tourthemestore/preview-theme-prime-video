	...
	<div class="col-md-12">
		<div class="profile_box main_block" style="min-height: 80px;">
			...
			<?php
				...
				$single_person_cost = ($sq_tour_deatils['single_person_cost']!="") ? $sq_tour_deatils['single_person_cost']: 0.00;
	        ...
	        <?php
				...
				$total_seats = $total_adult + $total_b_children + $total_wb_children + $total_infant + $single_person_cost;
			?>
	        <div class="row">
				<div class="col-sm-12">
	        	    <span class="main_block">
	        	    ...
	        	    <span class="main_block">
	        	      	<i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
	        	      	<?php echo "<label>Single Person Amount <em>:</em></label>" .$single_person_cost ?> 
	        	    </span>
	        	    <span class="main_block">
	        	      	<i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
