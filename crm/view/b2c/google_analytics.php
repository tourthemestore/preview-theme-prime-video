...
<form id="section_ganalytics">
    <div class="row mg_bt_20">
        ...
        <div class="col-md-4">
            <a target="_blank" href="https://www.youtube.com/watch?v=f3X-hYRxBL8"
                class="btn btn-sm btn-success text-right"><i class="fa fa-eye"></i>Reference video</a>
        </div>
    </div>
    <div class="row mg_bt_20">
        <div class="col-md-12 mg_bt_10">
            <textarea id="google_ana" name="google_ana" class="form-control" placeholder="Google analytics Code"
                title="Google analytics Code"><?= $query['google_analytics'] ?></textarea>
        </div>
    </div>
