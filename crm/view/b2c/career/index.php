...
?>
<legend>Enter Career Openings </legend>
<div class="row text-right mg_tp_20">	
    <div class="col-md-12">
        <button class="btn btn-info btn-sm ico_left" onclick="save_modal()"  id="btn_save_modal"><i class="fa fa-plus"></i>&nbsp;&nbsp;Career</button>
    </div>
</div>
...
function save_modal(){
	...
	$.post('career/save_modal.php', {}, function(data){
...
function list_reflect(){
	...
	$.post('career/list_reflect.php', {}, function(data){
		$('#div_list').html(data);
	});
}
list_reflect();
function update_modal(entry_id){
	...
	$.post('career/update_modal.php', {entry_id:entry_id}, function(data){
