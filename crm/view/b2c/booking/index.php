...
$question_count = mysqli_num_rows(mysqlQuery("select * from b2c_generic_settings where status='1'"));
$sq_query = mysqlQuery("select * from b2c_generic_settings where status='1'");
?>
...
<legend>Booking</legend>
    ...
    <div class="row mg_bt_10">
        <div class="col-md-11">
            <small class="note">Note : Save this settings using 'Save' button!</small>
        </div>
    </div>
        ...
        ?>
            <div class="row mg_bt_10">
                <div class="col-md-1 col-sm-1">
                    ...
                    <input class="form-control" type="number" value="<?= $count ?>" readonly  style="padding:5px !important;"/>
                </div>
...
<script>
    ...
    $.post(
        base_url + "controller/b2c_settings.php",
        {
            entry_id: entry_id,
            answer: answer
        },
