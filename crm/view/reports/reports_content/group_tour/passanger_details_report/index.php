...
<div class="row mg_bt_10">
	<div class="col-md-12 text-right">
		<button class="btn btn-excel btn-sm" onclick="excel_export_this()" data-toggle="tooltip" title="Generate Excel"><i class="fa fa-file-excel-o"></i></button>
	</div>
</div>
...
function passanger_reflect(){
	...
	$.post('reports_content/group_tour/passanger_details_report/passenger_details_report.php', {id : id,tour_id :tour_id, group_id : group_id,branch_status:branch_status}, function(data){
...
function excel_export_this()
{
	var id = $('#booking_id_filter3').val();
	var tour_id = $('#tour_id_filter').val();
	var group_id = $('#group_id_filter').val();
	window.location = 'reports_content/group_tour/passanger_details_report/excel_report.php?tourName='+tour_id+'&tourDate='+group_id+'&tourBooking='+id;
