...
function tour_group_dynamic_reflect1()
{
  var traveler_id = $('#tour_id_filter').val();
    ...
    $.post('reports_content/package_tour/repeater_tourist_report/repeater_tourist_report_filter.php', { traveler_id:traveler_id,branch_status:branch_status}, function(data){
