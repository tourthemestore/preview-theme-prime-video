...
$sq = mysqli_fetch_assoc(mysqlQuery("select branch_status from branch_assign where link='reports/staff_mgmt/index.php'"));
 ...
 <div class="app_panel_content Filter-panel">
  <div class="row">
    <div class="col-md-3 col-sm-6 mg_bt_10_xs col-md-offset-4">
      <select name="per_year_filter" style="width: 100%" id="per_year_filter" title="Year" onchange="list_reflect();">
...
<script>
 $('#per_year_filter').select2();
function list_reflect()
{
  var year = $('#per_year_filter').val();
