...
$email_id_data =  mysqli_fetch_array(mysqlQuery("SELECT * FROM emp_master where emp_id='1'"));
...
$temp_array = array(
    ...
    'email_id' => $email_id_data['email_id'],
...
$data= mb_convert_encoding($final_array,'UTF-8','UTF-8');
