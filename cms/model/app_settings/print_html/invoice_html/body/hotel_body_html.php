...
$tax_show = '';
$newBasic = 0;
$total_paid = (float)($total_paid) + (float)($credit_card_charges);
...
$net_amount1 = 0;
$net_amount1 =  $basic_cost1 + $service_charge  + $sq_hotel['markup'] + $markupservice_tax_amount + $service_tax_amount - $discount - $tds + (float)($roundoff) + $tcs_tax_amt;
...
if ($bg != '') {
  ...
  $balance = (float)($net_amount1) - (float)($total_paid) + (float)($charge);
}
...
<div class="col-md-12 mg_tp_20">
  <p class="border_lt"><span class="font_5">GUEST NAME : <?= $sq_hotel['pass_name'] ?></span></p>
</div>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="main_block inv_rece_calculation border_block">
        ...
        if ($bg != '') { ?>
          <div class="col-md-6">
            <p class="border_lt"><span class="font_5">DISCOUNT</span><span class="float_r"><?= $discount1 ?></span></p>
          </div>
          <div class="col-md-6">
            <p class="border_lt"><span class="font_5">CANCELLATION CHARGES</span><span class="float_r"><?= $canc_amount ?></span></p>
          </div>
          <div class="col-md-6">
            <p class="border_lt"><span class="font_5">TDS</span><span class="float_r"><?= $tds1 ?></span></p>
          </div>
          <div class="col-md-6">
            <p class="border_lt"><span class="font_5">CURRENT DUE </span><span class="font_5 float_r"><?= $balance ?></span></p>
          </div>
        ...
        <?php } ?>
        <div class="col-md-6">
          <p class="border_lt"><span class="font_5">TCS<?= '(' . $tcs_per . '%)' ?></span><span class="float_r"><?= $tcs_tax ?></span></p>
        </div>
        <div class="col-md-6">
          <p class="border_lt"><span class="font_5">&nbsp;</span><span class="float_r"></span></p>
        </div>
