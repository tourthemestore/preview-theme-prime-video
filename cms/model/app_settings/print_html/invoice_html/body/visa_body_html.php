...
if ($bg != '') {
  $due = ($total_paid > $canc_amount) ? 0 : (float)($canc_amount) - (float)($total_paid) + (float)($credit_card_charges);
} else {

  $due = ((float)($net_amount1) + (float)($sq_hotel['roundoff']) + (float)($credit_card_charges)) - (float)($total_paid);
}
...
<div class="row">
  <div class="col-md-12 mg_tp_20">
    <p class="border_lt"><span class="font_5">PASSENGER(S) : </span><span><?= $pass_count ?></span></p>
  </div>
</div>
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="main_block inv_rece_calculation border_block">
        ...
        ?>
          <div class="col-md-6">
            <p class="border_lt"><span class="font_5">BASIC AMOUNT </span><span class="float_r"><?php echo $basic_service_amt1; ?></span></p>
          </div>
        <?php } else {
          $newBasic1 = currency_conversion($currency, $sq_hotel['currency_code'], $newBasic); ?>
          <div class="col-md-6">
            <p class="border_lt"><span class="font_5">BASIC AMOUNT </span><span class="float_r"><?php echo $newBasic1; ?></span></p>
          </div>
        <?php } ?>
        <div class="col-md-6">
          <p class="border_lt"><span class="font_5">TOTAL </span><span class="font_5 float_r"><?= $total1 ?></span></p>
        </div>
        <div class="col-md-6">
        ...
        <div class="col-md-6">
          <p class="border_lt"><span class="font_5">TAX </span><span class="float_r"><?= str_replace(',', '', $name) . $service_tax_amount_show[0] . ' ' . number_format($service_tax_amount_show1, 2) ?></span></p>
        </div>
        <?php
        if ($bg != '') { ?>
          <div class="col-md-6">
            <p class="border_lt"><span class="font_5">CANCELLATION CHARGES </span><span class="font_5 float_r"><?= $canc_amount ?></span></p>
          </div>
          <div class="col-md-6">
            <p class="border_lt"><span class="font_5">ROUND OFF </span><span class="font_5 float_r"><?= $roundoff1 ?></span></p>
          </div>
        <?php } ?>
        <div class="col-md-6">
          <p class="border_lt"><span class="font_5">CURRENT DUE </span><span class="font_5 float_r"><?= $due1 ?></span></p>
        </div>
        <?php
        if ($bg == '') { ?>
          <div class="col-md-6">
