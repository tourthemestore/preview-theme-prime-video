      ...
      <div class="table-responsive">
        <table class="table table-bordered no-marg" id="tbl_emp_list" style="padding: 0 !important;">
          ...
          <tbody>
            ...
            if ($bg != '') {
              $cur_due = ($payment_amount > $canc_amount) ? 0 : (float)($canc_amount) - (float)($payment_amount);
            } else {
              $cur_due = (float)($final_total1) - (float)($payment_amount);
            }
            ?>
          </tbody>
        </table>
  ...
  <div class="row">
    <div class="col-md-12 text-right">
      <div class="main_block inv_rece_calculation border_block">
        <div class="col-md-12 border_lt">
          <p>
          <div class="col-md-6 text-left"><span class="font_5">BASIC AMOUNT</span></div>
          <div class="col-md-6 float_r"><span><?= $currency_code_d . ' ' . number_format($main_total, 2) ?></span></div>
          </p>
        </div>
        <div class="col-md-12 border_lt">
          <p>
          <div class="col-md-6 text-left"><span class="font_5">TAX</span></div>
          <div class="col-md-6 float_r"><span><?= $currency_code_d . ' ' . number_format($main_tax_total, 2) ?></span></div>
          </p>
        </div>
        <div class="col-md-12 border_lt">
          <p>
          <div class="col-md-6 text-left"><span class="font_5">TOTAL</span></div>
          <div class="col-md-6 float_r"><span><?= $currency_code_d . ' ' . number_format($final_total, 2) ?></span></div>
          </p>
        </div>
        <?php if ($query['coupon_code'] != '') { ?>
          <div class="col-md-12 border_lt">
            ...
            <div class="col-md-6 float_r"><span><?= $currency_code_d . ' ' . '-' . number_format($coupon_amount, 2) ?></span></div>
            </p>
          </div>
          <div class="col-md-12 border_lt">
            <p>
            <div class="col-md-6 text-left"><span class="font_5">NET AMOUNT</span></div>
            <div class="col-md-6 float_r"><span><?= $currency_code_d . ' ' . number_format($final_total1, 2) ?></span></div>
            </p>
          </div>
        <?php } ?>
        <div class="col-md-12 border_lt">
          ...
          <div class="col-md-6 float_r"><span><?= $currency_code_d . ' ' . number_format($payment_amount, 2) ?></span></div>
          </p>
        </div>
        <?php
        if ($bg != '') { ?>
          <div class="col-md-12 border_lt">
            ...
            <div class="col-md-6 float_r"><span><?= $currency_code_d . ' ' . number_format($canc_amount, 2) ?></span></div>
            </p>
          </div>
        <?php } ?>
        <div class="col-md-12 border_lt">
          ...
          <div class="col-md-6 float_r"><span><?= $currency_code_d . ' ' . number_format($cur_due, 2) ?></span></div>
          </p>
        </div>
      </div>
    </div>
