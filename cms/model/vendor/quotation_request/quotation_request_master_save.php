...
public function quotation_request_save()
{
	...
	$check_in_date_arr = $_POST['check_in_date_arr'];
   $check_out_date_arr =$_POST['check_out_date_arr'];
...
foreach ($hotel_id_arr as $index => $hotel_id) {
    $entry = [
        ["name" => "hotel_id", "value" => $hotel_id],
        ["name" => "check_in_date", "value" => $check_in_date_arr[$index]],
        ["name" => "check_out_date", "value" => $check_out_date_arr[$index]],
        ["name" => "total_rooms", "value" => $total_rooms_arr[$index]],
        ["name" => "room_type", "value" => $room_type_arr[$index]],
        ["name" => "meal_plan", "value" => $meal_plan_arr[$index]]
    ];
    // $dmc_entries_json  = $entry;
	$dmc_entries_json[] = $entry;

}

// Convert the array to JSON
$dmc_entries= json_encode($dmc_entries_json , JSON_UNESCAPED_SLASHES);
