      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="row mg_tp_10 mg_bt_10">
            ...
            <div class="col-md-4 mg_bt_10">
              <button type="button" data-toggle="tooltip" class="btn btn-excel" title="This tab is used to manage and store credit card information for  companies. This data helps in tracking and managing financial transactions related to company credit cards."><i class="fa fa-question-circle"></i></button>
            </div>
...
<script>
  ...
  function generate_identifier_block(identifier_count, i) {
    ...
    if (identifier_count <= 9) {
      $.post('credit_card_charges/generate_identifier_block.php', {
      ...
      error_msg_alert("Identifier count should be less than or equal to 9!");
      return false;
    }
  }
  ...
  function generate_membership_block() {
    ...
    $.post('credit_card_charges/generate_membership_block.php', {
      dynamic_div_count: dynamic_div_count
    }, function(data) {
    ...
    $('#frm_save').validate({
      ...
      submitHandler: function(form) {
        ...
        $.post(base_url + "controller/app_settings/credit_card_charges/save.php", {
            ...
            credit_card_charges: credit_card_charges,
            tax_charges_in: tax_charges_in,
            bank_id: bank_id,
            tax_on_credit_card_charges: tax_on_credit_card_charges,
            membership_details_arr: membership_details_arr
          },
          function(data) {
