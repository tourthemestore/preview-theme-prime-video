...
<div class="row mg_tp_20">
    <div class="col-md-12 no-pad">
        <div class="table-responsive">
            ...
            <table class="table table-bordered table-hover text-center" id="train_upload_ticket"
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-info btn-sm"><a href="<?= $url ?>" download title="Download"><i
...
function train_ticket_upload_url_save(train_ticket_url) {
    ...
    $.ajax({
        ...
        data: {
            ...
            train_ticket_url: train_ticket_url
        },
