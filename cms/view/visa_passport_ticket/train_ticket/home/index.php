...
<div class="row text-right mg_bt_10">
    <div class="col-md-12">
        ...
        <button class="btn btn-info btn-sm ico_left mg_bt_10" onclick="save_modal()" id="flight_btn"><i
                class="fa fa-plus"></i>&nbsp;&nbsp;Train Ticket</button>
    </div>
</div>
    ...
    <div class="row">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
            <button class="btn btn-sm btn-info ico_right"
                onclick="train_ticket_customer_list_reflect()">Proceed&nbsp;&nbsp;<i
...
function calculate_total_amount() {
    ...
    basic_fair = ($('#basic_show').html() == '&nbsp;') ? basic_fair : parseFloat($('#basic_show').text().split(' : ')[
        1]);
    ...
    var total_amount = parseFloat(basic_fair) + parseFloat(service_tax_amount) + parseFloat(service_charge) +
...
function excel_report() {
    ...
    window.location = 'home/excel_report.php?customer_id=' + customer_id + '&train_ticket_id=' + train_ticket_id +
...
function p_delete_entry(booking_id) {
    ...
    $('#vi_confirm_box').vi_confirm_box({
        callback: function(data1) {
            if (data1 == "yes") {
                var branch_status = $('#branch_status').val();
                var base_url = $('#base_url').val();
                $.post(base_url + 'controller/visa_passport_ticket/train_ticket/ticket_master_delete.php', {
