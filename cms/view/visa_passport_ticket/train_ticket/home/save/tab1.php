...
<div class="panel panel-default panel-body app_panel_style feildset-panel mg_tp_20">
	...
	<div class="row">
		...
		<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10_xs">
			...
			<select name="customer_id" id="customer_id" class="customer_dropdown app_select2" title="Select Customer Name" style="width:100%" onchange="customer_info_load();get_auto_values('booking_date','basic_fair','payment_mode','service_charge','markup','save','true','basic','basic');">
