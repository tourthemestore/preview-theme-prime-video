        ...
        <div class="row">
          ...
          <div class="col-md-3 col-sm-6 mg_bt_10">
           ...
           <div class="col-sm-3 col-xs-6 mg_bt_10">
            <select name="state" class="form-control" id="state" title="Select State/Country Name" style="width: 100%" required class="app_select2">
...
$('#state').select2({
  dropdownParent: $("#train_save_modal")});
