...
<script>
	...
	function list_reflect() {
		...
		$.post(base_url + 'view/b2c/sales/summary/list_reflect.php', {
	...
	function exc_view_modal(booking_id) {
		...
		var base_url = $('#base_url').val();
		$.post(base_url + 'view/b2c/sales/summary/view/index.php', {
			booking_id: booking_id
		}, function(data) {
	...
	function booking_id_dropdown_load(customer_id_filter, booking_id_filter) {
		...
		var base_url = $('#base_url').val();
		$.post(base_url + "view/b2c/sales/summary/booking_id_dropdown_load.php", {
			customer_id: customer_id
		}, function(data) {
	...
	function supplier_view_modal(booking_id) {
		...
		$.post(base_url + 'view/b2c/sales/summary/view/supplier_view_modal.php', {
			booking_id: booking_id
		}, function(data) {
	...
	function payment_view_modal(booking_id) {
		...
		$.post(base_url + 'view/b2c/sales/summary/view/payment_view_modal.php', {
			booking_id: booking_id
		}, function(data) {
			$('#div_exc_content_display').html(data);
