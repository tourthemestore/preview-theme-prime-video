...
<form id="section_package">
    ...
    <div class="row mg_bt_20">
        <div class="col-md-12">
            <table id="tbl_dest_tours" name="tbl_dest_tours" class="table border_0 table-hover no-marg" style="width:100%">
                <?php
                if (sizeof($popular_dest) == 0) { ?>
                    <tr>
                        ...
                        <td><select name="dest_name-1" id="dest_name-1" onchange="package_dynamic_reflect(this.id);get_package_image(this.id)" style="width:300px;" class="form-control app_select2">
                        ...
                        <td><select id="package-1" name="package-1" title="Select Tour" class="form-control" style="width:200px">
                                <option value="">*Select Tour</option>
                            </select></td>
                        <td><select id="image-1" name="image-1" title="Select Image" class="form-control app_select2" style="width:120px!important;">
                    ...
                    ?>
                        <tr>
                            ...
                            <td><select id="package-1<?= $i ?>_u" name="package-1<?= $i ?>_u" title="Select Tour" class="form-control" style="width:100%;">
                                    <?php if ($tour_id != '0') { ?>
                                        <option value="<?= $sq_package['tour_id'] ?>"><?= $sq_package['tour_name'] ?></option>
                                    <?php } ?>
                                    <option value="">*Select Tour</option>
                                </select></td>
                            <td><select id="image-1<?= $i ?>_u" name="image-1<?= $i ?>_u" title="Select Image" class="form-control app_select2" style="width:150px!important;">
                                    <?php if ($image_url != '') { ?>
            ...
            submitHandler: function(form) {
                ...
                for (var i = 0; i < rowCount; i++) {
                    ...
                    if (row.cells[0].childNodes[0].checked) {
                        ...
                        if (package == "") {
                            error_msg_alert("Select group tour at row " + (i + 1));
                            return false;
                        }
                        if (url == "") {
