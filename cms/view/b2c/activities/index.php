        ...
        <div class="col-md-12">
            <table id="tbl_activities" name="tbl_activities" class="table border_0 table-hover no-marg">
                ...
                <tr>
                    ...
                    <td><input maxlength="15" value="1" type="text" name="no" placeholder="Sr. No." class="form-control"
                            disabled /></td>
                    <td><select name="city_name-1" id="city_name-1" onchange="excursion_dynamic_reflect(this.id)"
                            style="width:100%" class="form-control city_name_u" title="Select City">
                            <?php if ($city_id != '') { ?>
                            <option value="<?= $sq_city['city_id'] ?>" selected="selected"><?= $sq_city['city_name'] ?>
                            </option>
                            <?php } ?>
                        </select>
                    </td>
                    <td><select id="exc-1" name="exc-1" class="form-control" style="width:100%" title="Select Activity">
                            ...
                            <option value="<?= $popular_activities[$i]->exc_id ?>">
                                <?= $popular_activities[$i]->exc_id ?></option>
                            <?php } ?>
                ...
                <tr>
                    ...
                    <td><select name="city_name-1<?= $i ?>_u" id="city_name-1<?= $i ?>_u"
                            onchange="excursion_dynamic_reflect(this.id)" style="width:100%"
                            class="form-control city_name_u" title="Select City">
                            <?php if ($city_id != '') { ?>
                            <option value="<?= $sq_city['city_id'] ?>" selected="selected"><?= $sq_city['city_name'] ?>
                            </option>
                            <?php } ?>
