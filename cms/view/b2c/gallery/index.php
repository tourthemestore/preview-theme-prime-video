...
<form id="section_gallery">
    ...
    <div class="row mg_bt_20">
        <div class="col-md-8">
            <select class="form-control" style="width:100%" name="dest_id" id="dest_id"
                onchange="images_reflect(this.id);" title="Select Destination" data-toggle="tooltip" required>
                <?php
                if ($dest_id1 != '') {
...
function images_reflect(dest_id) {
    ...
    if (dest_id1 != '') {
        $.post('gallery/get_dest_images.php', {
            dest_id: dest_id1,
            gallery: gallery
        }, function(data) {
