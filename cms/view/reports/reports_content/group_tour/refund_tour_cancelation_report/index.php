...
<script>
  ...
  var column = [
    ...
    var group_id = $('#group_id_filter').val();
		...
		$.post('reports_content/group_tour/refund_tour_cancelation_report/refund_tour_cancelation_report_filter.php', {tour_id : tour_id,group_id : group_id,branch_status:branch_status}, function(data){
