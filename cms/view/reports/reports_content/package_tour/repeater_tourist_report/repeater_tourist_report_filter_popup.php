							...
							<table class="table table-bordered">
										...
										if($package_ids[0] != ""){
											for($i=0; $i<sizeof($package_ids); $i++)
											{
												...
												$sq = mysqli_fetch_assoc(mysqlQuery("select booking_id,tour_name,tour_from_date,tour_to_date,booking_date from package_tour_booking_master where booking_id='$package_ids[$i]'"));
