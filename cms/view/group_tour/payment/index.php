    ...
    <div class="row">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
            ...
            <select id="tour_id_filter" name="tour_id_filter"
                onchange="tour_group_dynamic_reflect(this.id,'group_id_filter');" style="width:100%"
                title="Select Tour">
...

{
    ...
    $.post(base_url + '/view/group_tour/payment/save_modal.php', {
...

{
    ...
    $.post(base_url + '/view/group_tour/payment/list_reflect.php', {
        tour_id: tour_id,
        group_id: group_id,
        ...
        pagination_load(data, columns, true, true, 10, 'gtour_r_book', true);
        $('.loader').remove();
    });
...
function customer_booking_dropdown_load() {
    ...
    var customer_id = $('#customer_id_filter').val();
    var base_url = $('#base_url').val();
    $.post(base_url + '/view/group_tour/payment/customer_booking_dropdown_load.php', {
        customer_id: customer_id
    }, function(data) {
...

{
    ...
    var cust_type = $('#cust_type_filter').val();
    var base_url = $('#base_url').val();
    $.post(base_url + '/view/group_tour/payment/company_name_load.php', {
        cust_type: cust_type,
        branch_status: branch_status
    }, function(data) {
...

{
    ...
    var base_url = $('#base_url').val();
    window.location = base_url + '/view/group_tour/payment/excel_report.php?tour_id=' + tour_id + '&from_date=' +
        from_date + '&to_date=' + to_date + '&financial_year_id=' + financial_year_id + '&group_id=' + group_id +
        '&customer_id=' + customer_id + '&booking_id=' + booking_id + '&payment_for=' + payment_for + '&payment_mode=' +
        payment_mode + '&cust_type=' + cust_type + '&company_name=' + company_name + '&branch_status=' + branch_status;
...

{
    ...
    var company_name = $('#company_filter').val();
    var base_url = $('#base_url').val();
    $.get(base_url + "/view/group_tour/payment/get_customer_dropdown.php", {
        cust_type: cust_type,
        company_name: company_name,
        branch_status: branch_status
    }, function(data) {
...

{
    ...
    url = base_url + 'view/bank_receipts/group_tour_payment/cash_payment_receipt.php?payment_amount=' + payment_amount +
        '&payment_type=' + payment_type + '&payment_id=' + payment_id + '&bank_name_reciept=' + bank_name_reciept;
...

{
    ...
    url = url = base_url + 'view/bank_receipts/group_tour_payment/cheque_payment_receipt.php?payment_id=' +
...
function whatsapp_send_r(booking_id, payment_amount, base_url) {
    $.post(base_url + 'controller/group_tour/booking_payment/receipt_whatsapp_send.php', {
        booking_id: booking_id,
    ...
    $('#vi_confirm_box').vi_confirm_box({
        callback: function(data1) {
            if (data1 == "yes") {
                var branch_status = $('#branch_status').val();
                var base_url = $('#base_url').val();
                $.post(base_url + 'controller/group_tour/booking_payment/group_tour_payment_delete.php', {
                    payment_id: payment_id
                }, function(data) {
