        ...
        <div class="modal-dialog modal-lg" style="width: 1150px !important;" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <select id="ferry_type" name="ferry_type" style="width:100%" title="Ferry/Cruise Type"
                        ...
                        <div class="col-sm-4">
                            <input class="form-control" type="text" id="ferry_name" name="ferry_name"
                                onkeypress="return blockSpecialChar(event);" placeholder="*Ferry/Cruise Name"
                                title="Ferry/Cruise Name" required>
                        </div>
                        <div class="col-sm-4">
                            <input class="form-control" type="number" id="seating_capacity" name="seating_capacity"
                                placeholder="*Seating Capacity" title="Seating Capacity" required>
                        </div>
                    </div>
                    <div class="row mg_tp_20">
                        <div class="col-sm-12">
                            <div class="div-upload" role="button" title="Upload Ferry/Cruise Image"
                                data-toggle="tooltip">
                    ...
                    <div class="row mg_tp_20">
                        <div class="col-md-4 col-sm-4 mg_bt_10_sm_xs">
                            ...
                            <textarea class="feature_editor" id="inclusions" name="inclusions" placeholder="Inclusions"
                                title="Inclusions" rows="3"></textarea>
                        </div>
                        <div class="col-md-4 col-sm-4">
                            <h3 class="editor_title">Exclusions</h3>
                            <textarea class="feature_editor" id="exclusions" name="exclusions" class="form-control"
                                placeholder="Exclusions" title="Exclusions" rows="3"></textarea>
                        </div>
                        <div class="col-md-4 col-sm-4 mg_bt_10_sm_xs">
                            <h3 class="editor_title">Terms & Conditions</h3>
                            <textarea class="feature_editor" id="terms" name="terms" placeholder="Terms & Conditions"
                                title="Terms & Conditions" rows="3"></textarea>
                        </div>
                    </div>
                    <div class="row text-center mg_tp_30">
                        <div class="col-md-12">
                            <button class="btn btn-sm btn-success" id="tsave"><i
...
<script src="<?php echo BASE_URL ?>view/ferry/js/master.js"></script>
