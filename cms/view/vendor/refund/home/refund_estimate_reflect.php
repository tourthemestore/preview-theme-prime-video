...
$sq_payment_info1 = mysqli_fetch_assoc(mysqlQuery("select sum(payment_amount) as sumpay from vendor_payment_master where estimate_id='$estimate_id' and clearance_status!='Pending' and clearance_status!='Cancelled'"));
...
<input type="hidden" name="estimate_type" id="estimate_type" value="<?= $estimate_type ?>">
