  ...
  <div class="modal-dialog modal-lg" role="document" style="width:95%; margin-top:20px">
    <div class="modal-content">
      ...
      <div class="modal-body">
			...
			?>
			<div class="row">  
				<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10_xs text-left">
					<select name="currency_code" id="acurrency_code1" title="Currency" style="width:100%"
						data-toggle="tooltip" required>
						<?php
						$sq_currencyd = mysqli_fetch_assoc(mysqlQuery("SELECT `id`,`currency_code` FROM `currency_name_master` WHERE id=" . $sq_vendor_estimate['currency_code']));
						?>
			...
			<legend>Supplier Purchase</legend>
				...
				<div class="row">					
					...
					<div class="col-md-3 col-sm-4 col-xs-12 mg_bt_10">
						...
						<input type="hidden" id="old_total" value="<?= $sq_vendor_estimate['net_total'] ?>"/>
					</div>
					<div class="col-md-3 col-sm-4 col-xs-12 mg_bt_10">
