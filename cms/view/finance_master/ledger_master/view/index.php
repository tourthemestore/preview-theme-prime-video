...
<div class="app_panel">
	<div class="app_panel_content">
		<div class="container">
			...
			<div class="main_block mg_bt_20 app_pane_content filter_panel">
...
<script>
	$('#lfrom_date_filter, #lto_date_filter').datetimepicker({
		timepicker: false,
		format: 'd-m-Y'
	});
	...
	function list_reflect() {
		...
		if (chk_trans == 1) {
			if (from_date_filter == '' || to_date_filter == '') {
				...
				error_msg_alert('Select From-To Date!');
				return false;
			} else {
	...
	// function show_history(module_entry_id, module_name, finance_transaction_id, payment_perticular,customer_id,usertype,ledger_id, ledger_name, type) {
	// 	var base_url = $('#base_url').val();
	// 	$.post(base_url + 'view/finance_master/ledger_master/view/display_history.php', {
	// 		module_entry_id: module_entry_id,
	// 		module_name: module_name,
	// 		finance_transaction_id: finance_transaction_id,
	// 		payment_perticular: payment_perticular,
	...
	function show_history(module_entry_id, module_name, finance_transaction_id, customer_id, usertype, ledger_name, type, ledger_id) {
		var base_url = $('#base_url').val();
		$.post(base_url + 'view/finance_master/ledger_master/view/display_history.php', {
			module_entry_id: module_entry_id,
			module_name: module_name,
	...
	function financial_from_date_v(from_date) {
		...
		$.post(base_url + 'view/finance_master/ledger_master/view/date_validation.php', {
			from_date: from_date,
			financial_year_id: financial_year_id
		}, function(data) {

			if (data == '0') {
				error_msg_alert("Date should be between Financial Year");
				return false;
			} else {
	...
	function excel_report() {
		...
		$.post(base_url + 'view/finance_master/ledger_master/view/excel_report.php', {
			from_date: from_date,
			to_date: to_date,
			ledger_id: ledger_id,
			financial_year_id: financial_year_id,
