...
<div class="row text-left mg_tp_10">
    <div class="col-md-12">
        <div class="col-md-12 no-pad table_verflow"> 
            ...
            <!-- //package Booking -->
            <?php
            $query = "select * from package_tour_booking_master where tour_status!='Disabled' and  tour_from_date > '$today1' and delete_status='0'";
            ...
            while($row_query=mysqli_fetch_assoc($sq_query)){
                ...
                ?>
                    ...
                    <td class="text-center"><button class="btn btn-info btn-sm" onclick="checklist_update('<?= $count?>','<?php echo $row_query['booking_id']; ?>','Package Tour','<?php echo $row_query['emp_id']; ?>');" data-toggle="tooltip" title="Update Checklist" target="_blank" id="checklist-<?= $count?>"><i class="fa fa-plus"></i></button></td>
            ...
            while($row_query=mysqli_fetch_assoc($sq_query)){
                ...
                ?>
                    ...
                    <td><?= "Admin" ?></td>
                    <td class="text-center"><button class="btn btn-info btn-sm" onclick="checklist_update('<?= $count?>','<?php echo $row_query['booking_id']; ?>','<?='B2C-'.$row_query['service']?>','<?php echo $row_query['emp_id']; ?>');" data-toggle="tooltip" title="Update Checklist" target="_blank" id="checklist-<?= $count?>"><i class="fa fa-plus"></i></button></td>
                    <td class="text-center"><h6 style="width: 90px;height: 30px;border-radius: 20px;font-size: 12px;line-height: 21px;text-align: center;background:<?= $bg_color ?>;padding:5px;color:<?= $text_color?>"><?= $status ?></h6></td>
                    <td class="text-center"><button class="btn btn-info btn-sm" onclick="whatsapp_wishes('<?= $row_query['phone_no'] ?>','<?= $customer_name ?>')" data-toggle="tooltip" title="WhatsApp wishes to customer"><i class="fa fa-whatsapp"></i></button></td>
                    </tr>
                <?php } } ?>
            <!-- Hotel Booking -->
            <?php
            ...
            while($row_query=mysqli_fetch_assoc($sq_query)){
                ...
                $sq = mysqlQuery("select * from hotel_booking_master where booking_id = '$row_query[booking_id]' and delete_status='0'");
                ...
                ?>
                    ...
                    <td class="text-center"><button class="btn btn-info btn-sm" onclick="checklist_update('<?= $count?>','<?php echo $row_query['booking_id']; ?>','Hotel Booking','<?php echo $sq_hotel['emp_id']; ?>');" data-toggle="tooltip" title="Update Checklist" target="_blank" id="checklist-<?= $count?>"><i class="fa fa-plus"></i></i></button></td>
                    <td class="text-center"><h6 style="width: 90px;height: 30px;border-radius: 20px;font-size: 12px;line-height: 21px;text-align: center;background:<?= $bg_color ?>;padding:5px;color:<?= $text_color?>"><?= $status ?></h6></td>
            ...
            <!-- Flight Booking -->
            <?php
            $query_flight = "select * from ticket_trip_entries where DATE(departure_datetime) > '$today' and ticket_id in (select ticket_id from ticket_master_entries where status!='Cancel') and status!='Cancel' ";
            ...
            while($row_query1=mysqli_fetch_assoc($sq_query1)){
                ...
                ?>
                    ...
                    <td><?php echo $contact_no; ?></td>
                    <td><?= ($sq_hotel['emp_id']=='0') ? "Admin" : $sq_emp['first_name'].' '.$sq_emp['last_name'] ?></td>
                    <td class="text-center"><button class="btn btn-info btn-sm" onclick="checklist_update('<?= $count?>','<?php echo $row_query1['ticket_id']; ?>','Flight Booking','<?php echo $sq_hotel['emp_id']; ?>');" data-toggle="tooltip" title="Update Checklist" target="_blank" id="checklist-<?= $count?>"><i class="fa fa-plus"></i></button></td>
                    <td class="text-center"><h6 style="width: 90px;height: 30px;border-radius: 20px;font-size: 12px;line-height: 21px;text-align: center;background:<?= $bg_color ?>;padding:5px;color:<?= $text_color?>"><?= $status ?></h6></td>
                    <td class="text-center"><button class="btn btn-info btn-sm" onclick="whatsapp_wishes('<?= $contact_no ?>','<?= $customer_name ?>')" data-toggle="tooltip" title="WhatsApp wishes to customer"><i class="fa fa-whatsapp"></i></button></td>
                    </tr>
                <?php }
            ...
            <!-- Train Booking -->
            <?php
            $sq_query_train = mysqlQuery("select * from train_ticket_master_trip_entries where DATE(travel_datetime) >= '$today' and train_ticket_id in (select train_ticket_id from train_ticket_master_entries where status!='Cancel') and train_ticket_id in (select train_ticket_id from train_ticket_master where delete_status='0')");
            while($row_query1=mysqli_fetch_assoc($sq_query_train)){
                ...
                if($pass_count!=$cancel_count){
                    ...
                    ?>
                        ...
                        <td class="text-center"><button class="btn btn-info btn-sm" onclick="checklist_update('<?= $count?>','<?php echo $row_query1['train_ticket_id']; ?>','Train Booking','<?php echo $sq_train['emp_id']; ?>');" data-toggle="tooltip" title="Update Checklist" target="_blank" id="checklist-<?= $count?>"><i class="fa fa-plus"></i></button></td>
            ...
            while($row_query1=mysqli_fetch_assoc($sq_query_bus)){
                ...
                if($sq_hotel_c!=0){
                    ...
                    <td class="text-center"><button class="btn btn-info btn-sm" onclick="checklist_update('<?= $count?>','<?php echo $row_query1['booking_id']; ?>','Bus Booking','<?php echo $sq_hotel['emp_id']; ?>');" data-toggle="tooltip" title="Update Checklist" target="_blank" id="checklist-<?= $count?>"><i class="fa fa-plus"></i></button></td>
            ...
            while($row_query1=mysqli_fetch_assoc($sq_query_exc)){
                ...
                $sq_hotel = mysqli_fetch_assoc(mysqlQuery("select * from excursion_master where exc_id = '$row_query1[exc_id]' and delete_status='0'"));
                ...
                ?>
                    ...
                    <td><?php echo $contact_no; ?></td>
                    <td><?= ($sq_hotel['emp_id']=='0') ? "Admin" : $sq_emp['first_name'].' '.$sq_emp['last_name'] ?></td>
                    <td class="text-center"><button class="btn btn-info btn-sm" onclick="checklist_update('<?= $count?>','<?php echo $row_query1['exc_id']; ?>','Excursion Booking','<?php echo $sq_hotel['emp_id']; ?>');" data-toggle="tooltip" title="Update Checklist" target="_blank" id="checklist-<?= $count?>"><i class="fa fa-plus"></i></button></td>
            ...
            while($row_query1=mysqli_fetch_assoc($sq_query_car)){
                ...
                ?>
                    ...
                    <td class="text-center"><button class="btn btn-info btn-sm" onclick="checklist_update('<?= $count?>','<?php echo $row_query1['booking_id']; ?>','Car Rental Booking','<?php echo $row_query1['emp_id']; ?>');" data-toggle="tooltip" title="Update Checklist" target="_blank" id="checklist-<?= $count?>"><i class="fa fa-plus"></i></button></td>
            ...
            <!-- Group Booking -->
            <?php
                $sq = mysqlQuery("select * from tourwise_traveler_details where tour_group_status!='Cancel' and delete_status='0' ");
                while($row_query = mysqli_fetch_assoc($sq)){
                    ...
                    ?>
                        ...
                        <td><?php echo $contact_no; ?></td>
                        <td><?= ($row_query['emp_id']=='0') ? "Admin" : $sq_emp['first_name'].' '.$sq_emp['last_name'] ?></td>
                        <td class="text-center"><button class="btn btn-info btn-sm" onclick="checklist_update('<?= $count?>','<?php echo $row_query['id']; ?>','Group Tour','<?php echo $row_query['emp_id']; ?>');" data-toggle="tooltip" title="Update Checklist" target="_blank" id="checklist-<?= $count?>"><i class="fa fa-plus"></i></button></td>
            ...
            <!-- Visa Booking -->
            <?php
            $query_visa = "select * from visa_master_entries where appointment_date > '$today' and status!='Cancel' and visa_id in(select visa_id from visa_master where delete_status='0')";
            ...
            while($row_query_visa=mysqli_fetch_assoc($sq_query_visa)){
                ...
                <td class="text-center"><button class="btn btn-info btn-sm" onclick="checklist_update('<?= $count?>','<?php echo $row_query_visa['visa_id']; ?>','Visa Booking','<?php echo $sq_visa['emp_id']; ?>');" data-toggle="tooltip" title="Update Checklist" target="_blank" id="checklist-<?= $count?>"><i class="fa fa-plus"></i></button></td>
            ...
            <?php
            $query_pass = "select * from miscellaneous_master where DATE(created_at) > '$today' and misc_id in(select misc_id from miscellaneous_master_entries where status!='Cancel') and delete_status='0' order by misc_id desc";
