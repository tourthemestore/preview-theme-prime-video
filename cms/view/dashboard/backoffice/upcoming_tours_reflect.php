    ...
    <div class="col-md-12">
        <div class="col-md-12 no-pad table_verflow"> 
            ...
            <table class="table table-hover" style="border: 0;" id="tbl_utours_list">
                ...
                $query = "select * from package_tour_booking_master where tour_status!='Disabled' and financial_year_id='$financial_year_id' and tour_from_date > '$today1' and delete_status='0'";
                ...
                $query1 = "select * from hotel_booking_entries where status!='Cancel' and DATE(check_in) >= '$today' and booking_id in(select booking_id from hotel_booking_master where emp_id='$emp_id' and financial_year_id='$financial_year_id' and delete_status='0') and status!='Cancel'";                              
                ...
                $branch_status = $sq['branch_status'];
                $query_train = "select * from train_ticket_master_trip_entries where DATE(travel_datetime) > '$today' and train_ticket_id in(select train_ticket_id from train_ticket_master where emp_id='$emp_id') and train_ticket_id in(select train_ticket_id from train_ticket_master_entries where status!='Cancel') and train_ticket_id in (select train_ticket_id from train_ticket_master where delete_status='0')";
                ...
                $branch_status = $sq['branch_status'];
                $query_bus = "select * from bus_booking_entries where DATE(date_of_journey) > '$today' and booking_id in(select booking_id from bus_booking_master where emp_id='$emp_id' and financial_year_id='$financial_year_id') and status!='Cancel' and booking_id in(select booking_id from bus_booking_master where delete_status='0')";
                ...
                $branch_status = $sq['branch_status'];
                $query_exc = "select * from  excursion_master_entries where DATE(exc_date) > '$today1' and exc_id in(select exc_id from excursion_master where emp_id='$emp_id' and financial_year_id='$financial_year_id' and delete_status='0') and status!='Cancel'";
                ...
                $branch_status = $sq['branch_status'];
                $query_car = "select * from car_rental_booking where DATE(from_date) > '$today1' and travel_type ='Local' and emp_id='$emp_id' and status!='Cancel' and financial_year_id='$financial_year_id' and delete_status='0'";
                if($branch_status=='yes'){
                if($role=='Branch Admin' || $role=='Accountant' || $role_id>'7'){
                ...
                <?php } ?>
                <?php
                $query_car = "select * from car_rental_booking where DATE(traveling_date) > '$today1'  and travel_type ='Outstation' and status!='Cancel' and financial_year_id='$financial_year_id' and delete_status='0'";
                if($branch_status=='yes'){
                if($role=='Branch Admin' || $role=='Accountant' || $role_id>'7'){
                    $query_car .= " and branch_admin_id = '$branch_admin_id'";
                }
            ...
            while($row_query_visa=mysqli_fetch_assoc($sq_query_visa)){
                ...
                <?php
                $query_pass = "select * from miscellaneous_master where DATE(created_at) > '$today' and misc_id in(SELECT `misc_id` FROM `miscellaneous_master_entries` WHERE `status`!='Cancel') and emp_id='$emp_id' and delete_status='0' order by misc_id desc";
