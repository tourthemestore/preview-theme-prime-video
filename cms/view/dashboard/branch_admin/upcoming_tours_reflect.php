    ...
    <div class="col-md-12">
        <div class="col-md-12 no-pad table_verflow"> 
            ...
            while($row_query=mysqli_fetch_assoc($sq_query)){
                ...
                while($row_query=mysqli_fetch_assoc($sq_query)){
                $query1 = "select * from hotel_booking_master where booking_id = '$row_query[booking_id]' and delete_status='0'";
                if($branch_status=='yes'){
                    if($role=='Branch Admin' || $role=='Accountant' || $role=='Hr' || $role_id>'7'){
                ...
                and ticket_id in (select ticket_id from ticket_master_entries where status!='Cancel') and status!='Cancel'";
                $sq_query1 = mysqlQuery($query_flight);
                while($row_query1=mysqli_fetch_assoc($sq_query1)){
                $query1 = "select * from ticket_master where ticket_id = '$row_query1[ticket_id]' and delete_status='0'";
                if($branch_status=='yes'){
                    if($role=='Branch Admin' || $role=='Accountant' || $role=='Hr' || $role_id>'7'){
                    $query1 .= " and branch_admin_id = '$branch_admin_id'";
                    }
                ...
                $query1 = "select * from train_ticket_master where train_ticket_id = '$row_query1[train_ticket_id]' and delete_status='0'";
                if($branch_status=='yes'){
                    if($role=='Branch Admin' || $role=='Accountant' || $role=='Hr' || $role_id>'7'){
                    $query1 .= " and branch_admin_id = '$branch_admin_id'";
                    }
                ...
                $query1 = "select * from bus_booking_master where booking_id = '$row_query1[booking_id]' and delete_status='0'";
                ...
                $query1 = "select * from excursion_master where exc_id = '$row_query1[exc_id]' and delete_status=0";
                if($branch_status=='yes'){
                    if($role=='Branch Admin' || $role=='Accountant' || $role=='Hr' || $role_id>'7'){
                        $query1 .= " and branch_admin_id = '$branch_admin_id'";
                    }
                ...
                $branch_status = $sq_branch['branch_status'];
                $query_car = "select * from car_rental_booking where DATE(from_date) > '$today' and status!='Cancel' and travel_type ='Local' and delete_status='0'";
                if($branch_status=='yes'){
                if($role=='Branch Admin' || $role=='Accountant' || $role=='Hr' || $role_id>'7'){
                ...
                $branch_status = $sq_branch['branch_status'];
                $query1 = "select * from tourwise_traveler_details where 1 and tour_group_status!='Cancel' and delete_status='0' ";
                if($branch_status=='yes'){
                if($role=='Branch Admin' || $role=='Accountant' || $role=='Hr' || $role_id>'7'){
                    $query1 .= " and branch_admin_id = '$branch_admin_id'";
                }
            ...
            ?>
                ...
                $query1 = "select * from visa_master where visa_id = '$row_query_visa[visa_id]' and delete_status='0'";
                if($branch_status=='yes'){
                    if($role=='Branch Admin' || $role=='Accountant' || $role=='Hr' || $role_id>'7'){
                    $query1 .= " and branch_admin_id = '$branch_admin_id'";
                    }
                ...
                <?php
                $sq_branch = mysqli_fetch_assoc(mysqlQuery("select branch_status from branch_assign where link='miscellaneous/index.php'"));
                $query_pass = "select * from miscellaneous_master where DATE(created_at) > '$today' and delete_status='0' and misc_id in(SELECT `misc_id` FROM `miscellaneous_master_entries` WHERE `status`!='Cancel') ";
                $branch_status = $sq_branch['branch_status'];         
                if($branch_status=='yes'){
                    if($role=='Branch Admin' || $role=='Accountant' || $role=='Hr' || $role_id>'7'){
