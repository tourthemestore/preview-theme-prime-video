...
while($row_quotation = mysqli_fetch_assoc($sq_quotation)){
	...
	$currency_amount1 = currency_conversion($currency, $row_quotation['currency_code'], $row_quotation['total_tour_cost']);

		if ($row_quotation['currency_code'] != '0' && $currency != $row_quotation['currency_code'] && $row_quotation['total_tour_cost'] != $currency_amount1) {
	...
	$temp_arr = array( "data" => array(
		...
		$row_quotation['total_tour_cost'].$currency_amount,
		$emp_name,
