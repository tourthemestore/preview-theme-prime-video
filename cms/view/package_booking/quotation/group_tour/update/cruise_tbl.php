<div class="row">
    <div class="col-xs-12 text-right mg_bt_10_sm_xs">
        <button type="button" class="btn btn-excel btn-sm" title="Add Row" onClick="addRow('tbl_dynamic_cruise_quotation_update')"><i class="fa fa-plus"></i></button>
    </div>
</div>
<div class="row">
    <div class="col-xs-12">
        ...
        <table id="tbl_dynamic_cruise_quotation_update" name="tbl_dynamic_cruise_quotation_update" class="table mg_bt_0 table-bordered mg_bt_10">
        	...
        	if($sq_cruise_count==0){
        		?>
				<tr>
	                <td><input class="css-checkbox" id="chk_tour_group" type="checkbox"><label class="css-label" for="chk_tour_group"><label></td>
