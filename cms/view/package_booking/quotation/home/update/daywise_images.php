    ...
    <div class="app_panel">
        ...
        <div class="container">
            ...
            <div class="row mg_tp_20">
                <h4>Update uploaded Images</h4>
                <hr>
                <div id="daywise_image_select"></div>
            </div>
            <div class="row text-center mg_tp_20">
                <div class="col-xs-12">
                    <button class="btn btn-info btn-sm ico_left" type="button" onclick="back_to_tab_d()"><i
                            class="fa fa-arrow-left"></i>&nbsp;&nbsp;Previous</button>
                    &nbsp;&nbsp;
                    <button class="btn btn-info btn-sm ico_right" id="day_next">Next&nbsp;&nbsp;<i
