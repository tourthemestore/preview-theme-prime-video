                    ...
                    <table  class="table table-bordered no-marg">
                      ...
                      <tbody>
                        ...
                        while($row_entry = mysqli_fetch_assoc($sq_query))
                        {
                          ...
                          $pkg_query=mysqli_fetch_assoc(mysqlQuery("select * from package_tour_booking_master where booking_id='$booking_id'"));
                            $currency_amount2 = currency_conversion($currency,$pkg_query['currency_code'],$row_entry['amount']);
