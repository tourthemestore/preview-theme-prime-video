...
$sp_arrng = isset($sq['special_arrangments']) ? $sq['special_arrangments'] : '';
$sp_incl = isset($sq['inclusions']) ? $sq['inclusions']: '';
	...
	<div class="modal-content">
		...
		<div class="row">
			<div class="col-md-6 col-sm-6 mg_bt_10">
				<textarea id="special_arrangments" name="special_arrangments" onchange="validate_address(this.id)" placeholder="Special Arrangements" title="Special Arrangements"><?= $sp_arrng ?></textarea>
			</div>
			<div class="col-md-6 col-sm-6 mg_bt_10">
				<textarea id="inclusions" name="inclusions" placeholder="Inclusions" onchange="validate_address(this.id)" title="Inclusions"><?= $sp_incl ?></textarea>
			</div>
		</div>
		<?php } ?>
