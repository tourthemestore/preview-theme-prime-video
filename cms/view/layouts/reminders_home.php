...
$sq_birt_re = mysqli_num_rows(mysqlQuery("select * from remainder_status where remainder_name='emp_birthday' or remainder_name='cust_birthday' and date='$today'"));

$sq_hap_jou = mysqli_num_rows(mysqlQuery("select * from remainder_status where remainder_name='git_happy_journey' or remainder_name='fit_happy_journey' and date='$today'"));

$sq_chk_pen = mysqli_num_rows(mysqlQuery("select * from remainder_status where remainder_name='checklist_remainder' and date='$today'"));
