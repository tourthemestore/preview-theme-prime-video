...
<div class="row text-right mg_bt_10">
	<div class="col-xs-12">
		...
		<button class="btn btn-info btn-sm ico_left mg_bt_10" onclick="hotel_booking_save()"><i class="fa fa-plus"></i>&nbsp;&nbsp;Hotel Booking</button>
	</div>
</div>
...
function hotel_booking_save(){
	
	$.post('booking/booking_save_modal.php', { }, function(data){
