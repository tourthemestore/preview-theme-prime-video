    ...
    <div class="app_panel">
        ...
        <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table id="table_hotel_tarrif_offer" name="table_hotel_tarrif_offer"
                                    ...
                                    <tr>
                                        ...
                                        <td><select name="agent_type" id="agent_type" title="Agent Type"
                                                style="width: 300px" class="form-control app_select2" multiple>
            ...
            <div class="row text-center mg_tp_20 mg_bt_150">
                <div class="col-xs-12">
                    <button class="btn btn-info btn-sm ico_left" type="button" onclick="switch_to_tab4()"><i
                        ...
                        callback: function(data1) {
                            if (data1 == "yes") {
                                ...
                                window.location.href = base_url +
                                    'view/hotels/master/index.php?activeid=3';
                            }
                        }
                    });
                }
