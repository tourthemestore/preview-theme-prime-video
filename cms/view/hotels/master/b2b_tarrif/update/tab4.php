                                ...
                                <div class="table-responsive">
                                    <table id="table_hotel_tarrif_offer" name="table_hotel_tarrif_offer" class="table table-bordered no-marg pd_bt_51" style="width:100%">
                                        <tr>
                                            ...
                                            <td><select name="agent_type" id="agent_type" style="width: 300px" class="form-control app_select2" data-toggle="tooltip" title="Agent Type" multiple>
                                    ...
                                    <table id="table_hotel_tarrif_offer" name="table_hotel_tarrif_offer" class="table table-bordered no-marg pd_bt_51" style="min-width:1500px">
                                        ...
                                        while ($row_tab5 = mysqli_fetch_assoc($sq_tab5)) { ?>
                                            <tr>
                                                ...
                                                <td><select name="agent_type<?= $count ?>-u" id="agent_type<?= $count ?>-u" style="width: 300px" class="form-control app_select2" multiple>
                                                        <?php
        ...
        submitHandler: function(form) {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    tab2_room_cat_array: tab2_room_cat_array,
                    tab2_max_occ_array: tab2_max_occ_array,
                    tab2_from_date_array: tab2_from_date_array,
                    tab2_to_date_array: tab2_to_date_array,
                    tab2_double_bed_array: tab2_double_bed_array,
                    tab2_chwithbed_array: tab2_chwithbed_array,
                    tab2_chwobed_array: tab2_chwobed_array,
                    tab2_extra_bed_array: tab2_extra_bed_array,
                    tab2_markup_per_array: tab2_markup_per_array,
                    tab2_markup_cost_array: tab2_markup_cost_array,
                    tab2_meal_plan_array: tab2_meal_plan_array,
                    tab2_entry_id_array: tab2_entry_id_array,
                    tab2_checked_id_array: tab2_checked_id_array,
                    tab3_room_cat_array: tab3_room_cat_array,
                    tab3_max_occ_array: tab3_max_occ_array,
                    tab3_from_date_array: tab3_from_date_array,
                    tab3_to_date_array: tab3_to_date_array,
                    tab3_double_bed_array: tab3_double_bed_array,
                    tab3_chwithbed_array: tab3_chwithbed_array,
                    tab3_chwobed_array: tab3_chwobed_array,
                    tab3_extra_bed_array: tab3_extra_bed_array,
                    tab3_markup_per_array: tab3_markup_per_array,
                    tab3_markup_cost_array: tab3_markup_cost_array,
                    tab3_meal_plan_array: tab3_meal_plan_array,
                    tab3_entry_id_array: tab3_entry_id_array,
                    tab3_checked_id_array: tab3_checked_id_array,
                    tab4_room_cat_array: tab4_room_cat_array,
                    tab4_max_occ_array: tab4_max_occ_array,
                    tab4_day_array: tab4_day_array,
                    tab4_double_bed_array: tab4_double_bed_array,
                    tab4_chwithbed_array: tab4_chwithbed_array,
                    tab4_chwobed_array: tab4_chwobed_array,
                    tab4_extra_bed_array: tab4_extra_bed_array,
                    tab4_markup_per_array: tab4_markup_per_array,
                    tab4_markup_cost_array: tab4_markup_cost_array,
                    tab4_meal_plan_array: tab4_meal_plan_array,
                    tab4_entry_id_array: tab4_entry_id_array,
                    tab4_checked_id_array: tab4_checked_id_array,
                    ...
                    tab5_entry_id_array: tab5_entry_id_array,
                    tab5_checked_id_array: tab5_checked_id_array
                },
