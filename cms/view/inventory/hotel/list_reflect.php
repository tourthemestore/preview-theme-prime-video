                ...
                <tbody>
                    ...
                    <tr class="<?= $bg ?>">
                        ...
                        <td><button class="btn btn-info btn-sm"
                                style="color:red !important;cursor:pointer!important; padding: 0 5px 0 5px;"
                                onclick="history_modal(<?= $row_ser['entry_id'] ?>)" style="color:#009898;"
                                id="hhistory<?= $row_ser['entry_id'] ?>"
                                title="Show history"><?= $sq_hotel['hotel_name'] ?></button></td>
                        </td>
                        <td><?= $row_ser['rate'] ?></td>
                        ...
                        <td>
                            <button class="btn btn-info btn-sm" id="update_modal_inv_update_hotel-<?= $row_ser['entry_id'] ?>" onclick="update_modal(<?= $row_ser['entry_id'] ?>);"
