...
<style>
  ...
  #mobileSidebar .select2-container {
    z-index: 1056 !important; /* Higher than offcanvas backdrop (1055) */
  ...
  #mobileSidebar .select2-search__field:focus {
    border-color: #007bff !important;
    box-shadow: 0 0 0 0.2rem rgba(0, 123, 255, 0.25) !important;
    outline: none !important;
  }
  
  #mobileSidebar .select2-search__field:active,
  #mobileSidebar .select2-search__field:focus {
    pointer-events: auto !important;
  ...
  /* Ensure Select2 dropdown is visible in offcanvas */
  .offcanvas.show .select2-dropdown {
    display: block !important;
  }
  
  /* Prevent any overlay from blocking the search field */
  #mobileSidebar .select2-dropdown:before {
    display: none !important;
  }
  
  /* Ensure the search container is clickable */
  #mobileSidebar .select2-search {
    pointer-events: auto !important;
  }
</style>
